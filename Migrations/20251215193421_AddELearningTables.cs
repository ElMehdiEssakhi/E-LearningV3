...
{
    /// <inheritdoc />
    public partial class AddELearningTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamFinales", x => x.ExamFinalId);
                    table.ForeignKey(
                        name: "FK_ExamFinales_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contents_Chapters_ChapId",
                        column: x => x.ChapId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizzes_Chapters_ChapId",
                        column: x => x.ChapId,
                        principalTable: "Chapters",
                        principalColumn: "ChapId",
                        onDelete: ReferentialAction.Cascade);
